...
public class TinyDB {
    ...
    public ArrayList<PlayList> getListObject(String key) {
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<PlayList> objects = new ArrayList<PlayList>();

        for (String jObjString : objStrings) {
            PlayList value = gson.fromJson(jObjString, PlayList.class);
            objects.add(value);
        }
        return objects;
    }
    ...
    public void putListObject(String key, ArrayList<PlayList> objArray) {
        checkForNullKey(key);
        Gson gson = new Gson();
